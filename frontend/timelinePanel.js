...
function eventDetail({ event, participants, media, memberIndex, memberById, readOnly, memberQuery, memberResults, editing, editDraft, editingVisibility, editVisibilityPicker, shareCount }) {
