...
function mediaBody({ media, tags, memberIndex, memberById, readOnly, tagQuery, tagResults, editing, editDraft, editingVisibility, visibilityPicker, shareCount, editingDescription, descriptionDraft, context, commentState, currentUserId }) {
